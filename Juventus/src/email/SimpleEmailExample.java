...
public class SimpleEmailExample {
	...
	public static void main(String[] args) {
		...
		simpleEmail.setAuthentication("shamon_king", "rjaghkd12");
		...
		try {
			// 보내는사람 설정
			simpleEmail.setFrom("shamon_king@naver.com", "관리자", "utf-8");
			// 받는사람 설정
			simpleEmail.addTo("khbaseball@hanmail.net", "회원님", "utf-8");
			// 받는사람(참조인) 설정
